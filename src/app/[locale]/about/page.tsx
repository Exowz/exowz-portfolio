...
import { motion } from 'framer-motion'; // Using framer-motion is common, your 'motion/react' is fine too.
...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 md:p-12 bg-background">
      {/* FIX 1: Use the 'isClient' variable to prevent the hydration error */}
      {isClient && (
        <motion.div
