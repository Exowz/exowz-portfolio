export type CvFacet = 'data-eng' | 'ml' | 'ai-rag' | 'finance' | 'web' | 'sovereignty';
...
export const projects: Project[] = [
  ...
  {
    slug: 'green-ai-scanner',
    key: 'Green-AI-Scanner',
    tags: ['React', 'Node.js', 'Express', 'MongoDB', 'Mistral AI', 'Data Visualization'],
    facets: ['ai-rag', 'sovereignty', 'data-eng', 'web'],
    featured: true,
    github: 'https://github.com/Le-skal/Green-AI-Scanner',
    demo: 'https://green-ai.deepskal.com',
    date: '2026-03',
  },
  {
